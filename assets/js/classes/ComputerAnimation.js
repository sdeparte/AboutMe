...
export default class ComputerAnimation {
    adobeAn = {};
    ...
    constructor () {
        ...
        }).prototype = this.getMCSymbolPrototype(lib.Surface, new createjs.Rectangle(0,0,13.8,2.4), null);
        ...
        (lib.Shaker = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Shaker, new createjs.Rectangle(0,0,18.4,25.9), null);
        ...
        (lib.Ombre = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Ombre, new createjs.Rectangle(8.6,0,78.30000000000001,31.5), null);
        ...
        (lib.Main = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Main, new createjs.Rectangle(0,0,29.8,20.4), null);
        ...
        (lib.ClipGroup_3 = function(mode,startPosition,loop) {
            ...
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup_3, new createjs.Rectangle(0,0,0,0), null);
        ...
        (lib.ClipGroup_2 = function(mode,startPosition,loop) {
            ...
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup_2, new createjs.Rectangle(0,0,0,0), null);
        ...
        (lib.ClipGroup_1 = function(mode,startPosition,loop) {
            ...
            let maskedShapeInstanceList = [this.instance,this.instance_1,this.instance_2];

            for (let shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
                maskedShapeInstanceList[shapedInstanceItr].mask = mask;
            }

            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup_1, new createjs.Rectangle(5,16.8,50.8,36.5), null);
        ...
        (lib.ClipGroup_0 = function(mode,startPosition,loop) {
            ...
            let maskedShapeInstanceList = [this.instance,this.instance_1];

            for (let shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
                maskedShapeInstanceList[shapedInstanceItr].mask = mask;
            }

            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup_0, new createjs.Rectangle(11.7,3.1,46.599999999999994,38.9), null);
        ...
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup, new createjs.Rectangle(0,0,0,0), null);
        ...
        (lib.Path_1 = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Path_1, new createjs.Rectangle(0,0,49,114.3), null);
        ...
        (lib.Path = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Path, new createjs.Rectangle(0,0,27.6,95.1), null);
        ...
        (lib.Path_2 = function(mode,startPosition,loop) {
            ...
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Path_2, new createjs.Rectangle(0,0,24.3,26.9), null);
        ...
        (lib.Path_3 = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_2).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Path_3, new createjs.Rectangle(0,0,33.9,44.2), null);
        (lib.Path_1_1 = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_1).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Path_1_1, new createjs.Rectangle(0,0,49,114.3), null);
        ...
        (lib.Path_4 = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_3).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Path_4, new createjs.Rectangle(0,0,27.6,87), null);
        ...
        p.nominalBounds = new createjs.Rectangle(-21.4,56.1,186.5,207.4);
        ...
        (lib.Capuchon = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Capuchon, new createjs.Rectangle(0,0,26.5,15.9), null);
        ...
        (lib.Bulle_symfony = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_symfony, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        (lib.Bulle_swift = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_swift, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        (lib.Bulle_php = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_php, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        (lib.Bulle_mysql = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_mysql, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        (lib.Bulle_java = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_java, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        (lib.Bulle_flutter = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_flutter, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        (lib.Bulle_dotnet = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Bulle_dotnet, new createjs.Rectangle(-4,-4,194.5,194.5), null);
        ...
        }).prototype = this.getMCSymbolPrototype(lib.Avantbras, new createjs.Rectangle(0,0,61.2,28.9), null);
        (lib.ArriereBras = function(mode,startPosition,loop) {
            ...
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ArriereBras, new createjs.Rectangle(0,0,54.9,47.9), null);
        ...
        (lib.Allcodelines = function(mode,startPosition,loop) {
            ...
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Allcodelines, new createjs.Rectangle(0,0,30.1,30.3), null);
        ...
        (lib.Tete = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(31).to({_off:true},1).wait(26).to({_off:false},0).wait(71).to({_off:true},1).wait(9).to({_off:false},0).wait(60).to({_off:true},1).wait(9).to({_off:false},0).wait(52));
            this.timeline.addTween(createjs.Tween.get(this.instance_1).wait(32).to({_off:false},0).to({_off:true},1).wait(24).to({_off:false},0).to({_off:true},1).wait(72).to({_off:false},0).to({_off:true},1).wait(7).to({_off:false},0).to({_off:true},1).wait(61).to({_off:false},0).to({_off:true},1).wait(7).to({_off:false},0).to({_off:true},1).wait(52));
            this.timeline.addTween(createjs.Tween.get(this.instance_2).wait(33).to({_off:false},0).to({_off:true},1).wait(22).to({_off:false},0).to({_off:true},1).wait(74).to({_off:false},0).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(63).to({_off:false},0).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(53));
            this.timeline.addTween(createjs.Tween.get(this.instance_3).wait(34).to({_off:false},0).to({_off:true},1).wait(20).to({_off:false},0).to({_off:true},1).wait(76).to({_off:false},0).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},1).wait(65).to({_off:false},0).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},1).wait(54));
            this.timeline.addTween(createjs.Tween.get(this.instance_4).wait(35).to({_off:false},0).to({_off:true},1).wait(18).to({_off:false},0).to({_off:true},1).wait(78).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},1).wait(67).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},1).wait(55));
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]}).wait(261));
            this._renderFirstFrame();
        }).prototype = p = new createjs.MovieClip();

        p.nominalBounds = new createjs.Rectangle(-4.9,-3,66.10000000000001,66.5);
        ...
        p.nominalBounds = new createjs.Rectangle(-0.3,-4.7,15.3,26.7);
        ...
        (lib.PC = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_23).wait(46).to({_off:false},0).to({rotation:-5.231,x:67.1,y:-9.4},9,createjs.Ease.quadIn).wait(1));
        ...
        p.nominalBounds = new createjs.Rectangle(0,0,85.4,50.5);

        (lib.ClipGroup_4 = function(mode,startPosition,loop) {
            this.initialize(mode,startPosition,loop,{});

            // Calque_2 (mask)
            let mask_1 = new createjs.Shape();
            mask_1._off = true;
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup_4, new createjs.Rectangle(15.2,6.6,64.8,104.4), null);

        (lib.ClipGroup_5 = function(mode,startPosition,loop) {
            this.initialize(mode,startPosition,loop,{});

            // Calque_2 (mask)
            let mask_2 = new createjs.Shape();
            mask_2._off = true;
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.ClipGroup_5, new createjs.Rectangle(15.2,6.6,64.8,104.4), null);
        ...
        p.nominalBounds = new createjs.Rectangle(-21.4,27.8,201.20000000000002,235.7);
        ...
        (lib.Epaule = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Epaule, new createjs.Rectangle(-2.2,0,44.5,44.7), null);
        ...
        (lib.Bulle_symfony_animation = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance).wait(29).to({_off:false},0).wait(28));
        ...
        p.nominalBounds = new createjs.Rectangle(-3.5,-209.1,262,420.2);
        ...
        (lib.Torse = function(mode,startPosition,loop) {
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]}).wait(1));
            this._renderFirstFrame();
        }).prototype = this.getMCSymbolPrototype(lib.Torse, new createjs.Rectangle(-15.1,-6.5,96.8,114.5), null);
        ...
        (lib.Animation = function(mode,startPosition,loop) {
            ...
            let mask = new createjs.Shape();
            mask._off = true;
            let mask_graphics_14 = new createjs.Graphics().p("A8kriQg3gLg4gmQgpgbg2g0QhJhFgigxQgPgXgGghQgEgXAAgmQAAgRADgKQAEgMANgRQANgQAOgLQAWgQAdgEQAbgEAcAHQAdAIAfAWQASAMAiAdIAtAjQAaAUARAQIAZAXQAPANANAGQAJAFAUAHQATAGAKAFQAaANAYAjQAUAdAJAhQAJAigEAiQgCAXgKAQQgaAsg/AGIgQAAQglAAg4gLg");
            let mask_graphics_15 = new createjs.Graphics().p("A8ermQg3gKg5gmQgogag3g0QhJhEgjgxQgQgXgFghQgFgXAAgmQAAgRADgKQADgMAOgRQAMgQAOgLQAWgRAdgEQAbgEAcAHQAdAHAfAWQASAMAjAdIAtAiQAaAUARAQIAaAXQAOAMANAHQAJAEAVAHQATAGAKAFQAaANAYAjQAVAcAJAiQAJAigDAiQgDAXgJAPQgaAtg/AGIgSABQgkAAg3gLg");
            let mask_graphics_16 = new createjs.Graphics().p("A8XrpQg3gKg5glQgpgag4gzQhJhEgjgwQgQgXgGghQgFgXAAgmQgBgRADgKQADgNAOgQQAMgRAOgLQAVgRAdgEQAcgFAcAHQAdAHAfAWQASAMAjAcIAtAiQAbAUARAPIAaAXQAOAMAOAHQAJAEAUAHQATAGAKAEQAaANAZAjQAVAcAJAhQAKAigDAiQgCAXgKAQQgZAtg/AGIgUABQgkAAg1gJg");
            let mask_graphics_17 = new createjs.Graphics().p("A8LrxQg3gJg6gjQgqgZg5gyQhLhCgkgvQgQgXgHghQgFgWgCgmQgBgRADgKQADgNANgRQAMgRAOgMQAUgRAdgFQAcgFAcAGQAdAHAgAUQASAMAkAbIAuAhQAbAUASAOIAaAWQAPANANAGQAJAEAVAGQATAFAKAFQAaALAaAjQAVAcALAhQAKAhgCAiQgCAXgJAQQgYAug/AIQgMABgPAAQgiAAgwgHg");
            let mask_graphics_18 = new createjs.Graphics().p("A7/r5Qg3gHg7giQgrgZg5gwQhNhAglguQgRgWgIghQgGgXgCgmQgBgQACgLQADgMAMgSQAMgRANgMQAVgRAcgGQAbgGAdAGQAdAFAgAUQATALAkAaIAvAgQAcATASAOIAaAWQAQAMANAFQAJAEAVAGQAUAFAJAEQAbALAbAiQAWAbALAhQALAhgBAiQgBAYgJAQQgXAug/AJQgPADgUAAQgfAAgrgGg");
            let mask_graphics_19 = new createjs.Graphics().p("A7zsBQg4gGg7ghQgrgXg7gvQhPg+gmgtQgRgWgJggQgGgXgDgmQgCgRACgKQACgNAMgRQAMgSANgMQAUgSAcgHQAbgGAdAFQAdAFAhATQATALAlAZIAvAfQAcASATAOIAbAUQAPAMAOAFQAJAEAVAFQAUAFAKADQAbALAbAhQAXAbAMAgQAMAhgBAiQAAAXgIARQgWAug/AMQgTADgaAAQgcAAgkgEg");
            let mask_graphics_20 = new createjs.Graphics().p("A7nsJQg4gFg9gfQgrgWg8guQhQg8gngsQgSgWgKggQgGgWgFgmQgCgRACgKQACgNAMgSQALgSAMgMQAUgTAcgHQAbgHAdAEQAdAEAhATQAUAKAlAYIAwAeQAdARATAOIAbAUQAQALAOAFQAJADAVAFQAUAEAKAEQAbAKAdAgQAXAaANAgQANAhgBAiQABAXgIARQgVAvg+ANQgXAEghAAQgYAAgdgCg");
            let mask_graphics_21 = new createjs.Graphics().p("A7bsSQg4gDg+geQgsgVg9gsQhRg6gpgsQgSgUgKggQgHgWgGgmQgCgRACgKQABgNALgSQALgSAMgNQATgTAcgIQAbgIAdAEQAeADAhASQATAKAnAXIAxAcQAdARATANIAcATQAQALAOAFQAJADAVAEQAUAEAKADQAcAJAdAgQAYAZANAgQAOAhABAiQAAAXgHARQgTAvg/APQgbAGgpAAIgogCg");
            let mask_graphics_22 = new createjs.Graphics().p("A7QsaQg4gCg+gcQgsgUg/grQhSg4gqgrQgTgUgLgfQgHgXgHglQgCgRABgKQABgNALgTQAKgSAMgNQATgTAcgJQAagIAdACQAeADAhARQAUAJAnAXIAyAbQAdAQATAMIAdATQAQAKAOAFQAKADAVADQAUADAKADQAcAJAeAfQAYAZAPAfQAOAgACAjQABAXgHARQgSAwg+AQQggAHg0AAIgZAAg");
            let mask_graphics_23 = new createjs.Graphics().p("A7EsjQg5AAg+gbQgtgTg/gpQhUg2grgqQgUgUgLgfQgIgWgHglQgEgRABgKQACgNAKgTQAJgSAMgOQASgUAcgJQAagJAdACQAeACAiAQQAUAJAnAVIAzAaQAdAQAUAMIAdARQARALAOADQAJADAWADQAUADAKADQAcAIAeAeQAZAYAQAfQAPAgACAiQACAXgGARQgSAxg9ARQglAKhCAAIgFAAg");
            let mask_graphics_24 = new createjs.Graphics().p("A8wtEQgugShAgnQhVg0gsgpQgUgTgMgfQgJgWgIglQgEgRABgKQABgNAKgTQAJgTALgOQASgUAbgKQAagKAdACQAeABAjAPQAUAJAoAUIAyAZQAfAOAUAMIAdARQARAKAOADQAKADAVACQAUADAKACQAdAHAfAeQAaAXAPAfQAQAgAEAiQACAXgGARQgQAxg9ATQgmALhGABIgEAAQg2AAg9gYg");
            let mask_graphics_25 = new createjs.Graphics().p("A8mtKQgugRhBgmQhWgygtgnQgUgTgOgfQgJgVgJglQgEgRABgKQAAgNAJgTQAJgTALgOQARgVAcgLQAZgKAdABQAeAAAjAOQAVAIAoAUIAzAYQAfANAUALIAeARQARAJAOADQAKADAVACQAUABALADQAcAGAgAdQAaAXARAeQARAfAEAiQADAXgGARQgPAyg8AUQgmAMhGADIgKABQg0AAg6gWg");
            let mask_graphics_26 = new createjs.Graphics().p("A8ctQQgugQhCgkQhYgwgtgnQgVgSgOgeQgKgVgKglQgEgRAAgKQAAgNAJgTQAJgUAKgOQARgVAbgLQAZgLAdAAQAegBAjAOQAVAHApATIA0AWQAfANAUALIAeAPQASAJAOADQAKACAVACQAUABALACQAcAGAhAcQAbAWARAeQASAfAEAhQAEAXgFASQgOAxg8AWQgmANhFAFIgQABQgxAAg4gTg");
            let mask_graphics_27 = new createjs.Graphics().p("A8YtUQgugQhCgjQhYgvgugnQgVgSgOgeQgKgVgKglQgFgQAAgLQAAgNAJgTQAIgUALgOQAQgVAbgMQAagLAdAAQAdAAAkANQAUAHApASIA0AWQAfANAVAKIAeAQQASAJAOACQAKACAVACQAUABALACQAcAFAhAcQAbAWASAeQARAeAGAiQADAXgFASQgNAxg8AXQglANhGAFIgSABQgwAAg3gSg");
            let mask_graphics_28 = new createjs.Graphics().p("A8UtYQgugPhDgjQhYgvgugmQgVgSgPgeQgKgVgKgkQgFgRAAgKQAAgNAJgUQAIgTAKgPQARgVAagMQAagLAdAAQAegBAjANQAVAHApASIA0AVQAfANAVAKIAeAPQASAJAOADQAKACAVABQAUABALACQAcAFAiAbQAbAWARAeQASAeAGAiQAEAXgFASQgNAxg8AXQglAOhGAGIgUAAQgvAAg2gRg");
            let mask_graphics_29 = new createjs.Graphics().p("A8QtcQgugPhDgiQhZgugugmQgVgSgPgeQgKgVgLgkQgFgQAAgLQAAgNAJgTQAHgUALgOQAQgWAbgMQAZgLAdgBQAegBAjANQAVAHApARIA1AWQAfAMAVAKIAeAPQASAIAOADQAKACAVABQAUABALABQAcAGAiAbQAbAWASAdQASAeAGAiQAEAXgFASQgMAyg8AXQglAOhGAGIgVABQgvAAg1gRg");
            let mask_graphics_30 = new createjs.Graphics().p("A8MtgQgugOhDgiQhaguguglQgWgRgOgeQgLgVgLglQgFgQAAgKQAAgNAIgUQAIgUAKgOQAQgWAbgMQAZgMAdAAQAegCAkANQAVAHApARIA0AVQAgAMAUAKIAfAPQASAIAOACQAKACAVABQAVABAKABQAdAFAhAbQAcAWASAdQASAeAGAiQAEAXgEARQgNAzg7AXQglAOhGAHIgXABQguAAg0gQg");
            let mask_graphics_31 = new createjs.Graphics().p("A8ItjQgvgOhDgiQhagtgvgkQgVgSgPgeQgLgVgLgkQgFgQAAgLQAAgNAIgTQAHgUALgPQAPgVAbgNQAZgLAdgCQAegBAkAMQAUAHAqARIA1AUQAfAMAVAKIAeAPQASAIAOACQAKACAWABQAUAAALACQAcAEAiAbQAcAWASAdQATAeAGAhQAEAXgEASQgMAyg7AYQgmAOhFAIIgZABQgtAAgzgPg");
            let mask_graphics_61 = new createjs.Graphics().p("A8ItjQgvgOhDgiQhagtgvgkQgVgSgPgeQgLgVgLgkQgFgQAAgLQAAgNAIgTQAHgUALgPQAPgVAbgNQAZgLAdgCQAegBAkAMQAUAHAqARIA1AUQAfAMAVAKIAeAPQASAIAOACQAKACAWABQAUAAALACQAcAEAiAbQAcAWASAdQATAeAGAhQAEAXgEASQgMAyg7AYQgmAOhFAIIgZABQgtAAgzgPg");
            let mask_graphics_62 = new createjs.Graphics().p("A8MtfQgvgPhDgiQhZgtgvglQgVgSgPgeQgKgVgLgkQgFgRAAgKQAAgNAIgUQAIgTAKgPQAQgVAbgMQAZgMAdgBQAegBAjAMQAVAHApARIA1AVQAfAMAVAKIAfAPQARAIAOADQAKACAWAAQAUABALACQAcAFAiAbQAbAVASAeQATAeAGAiQAEAWgFASQgMAyg7AXQgmAPhFAGIgYACQgtAAg0gQg");
            let mask_graphics_63 = new createjs.Graphics().p("A8QtcQgugOhDgjQhZgugvglQgVgSgOgeQgLgVgKglQgFgQAAgKQAAgNAIgUQAIgUAKgOQARgVAagMQAagMAdgBQAeAAAjAMQAVAHApASIA0AVQAgAMAUAKIAfAPQARAJAOACQAKACAWABQAUABAKACQAdAFAiAbQAbAWASAeQASAeAGAiQAEAWgFASQgNAyg7AXQgmAOhFAGIgWABQguAAg1gRg");
            let mask_graphics_64 = new createjs.Graphics().p("A8UtYQgugPhDgjQhZgugugmQgVgSgOgeQgKgWgLgkQgEgQAAgLQAAgNAIgTQAIgUALgOQAQgWAbgLQAZgMAdAAQAegBAkANQAUAHApASIA1AWQAfAMAUALIAfAPQARAIAOADQAKACAWABQAUABAKACQAdAFAhAcQAbAWASAeQASAeAFAiQAEAWgFASQgNAyg7AWQgmAOhFAGIgUABQgvAAg2gSg");
            let mask_graphics_65 = new createjs.Graphics().p("A8YtUQgugPhDgkQhYgvgugmQgVgSgOgfQgKgVgKgkQgEgRAAgKQAAgNAJgUQAIgTAKgOQARgWAbgLQAZgLAdgBQAeAAAjANQAVAHApATIA0AWQAfAMAVALIAeAPQARAJAOADQAKACAWABQAUABAKACQAdAGAhAbQAbAXARAdQASAfAFAiQAEAXgFARQgNAyg8AWQgmAOhGAFIgRAAQgxAAg2gSg");
            let mask_graphics_66 = new createjs.Graphics().p("A8ctQQgugQhCgkQhYgwgtgnQgVgSgOgeQgKgVgKglQgEgRAAgKQAAgNAJgTQAJgUAKgOQARgVAbgLQAZgLAdAAQAegBAjAOQAVAHApATIA0AWQAfANAUALIAeAPQASAJAOADQAKACAVACQAUABALACQAcAGAhAcQAbAWARAeQASAfAEAhQAEAXgFASQgOAxg8AWQgmANhFAFIgQABQgxAAg4gTg");
            let mask_graphics_67 = new createjs.Graphics().p("A8mtKQgugRhBgmQhXgygsgnQgVgTgNgfQgJgVgJglQgEgRAAgKQABgNAJgTQAJgTALgOQARgVAbgLQAagKAdABQAeAAAjAOQAUAIApAUIAzAXQAfAOAUALIAdARQASAJAOADQAKACAVACQAUACAKACQAdAHAgAdQAaAXARAeQAQAfAFAiQACAXgFARQgPAyg8AUQgnAMhFADIgKAAQg0AAg6gVg");
            let mask_graphics_68 = new createjs.Graphics().p("A8xtEQgtgShAgnQhWg0grgpQgUgTgNgfQgIgWgIglQgEgRABgKQABgNAJgTQAJgTAMgOQARgUAcgKQAagKAdACQAeABAiAPQAVAIAnAVIAzAZQAeAOAUAMIAeARQARAKAOADQAJADAWACQAUADAKACQAcAHAgAeQAZAXAQAfQAQAfADAjQADAXgGARQgQAxg9ASQgnAMhFABIgEAAQg3AAg9gYg");
            let mask_graphics_69 = new createjs.Graphics().p("A7FsjQg4gBg+gaQgtgThAgpQhUg2gqgqQgUgUgLgfQgJgWgHglQgDgRABgKQABgNAKgTQAKgTAMgNQASgUAcgJQAagJAdACQAeACAiAQQAUAJAnAVIAyAaQAeAPAUAMIAdASQAQAKAOAEQAKADAVADQAUADAKADQAcAHAfAfQAZAYAPAfQAPAgADAiQACAXgHARQgRAxg9ARQglAKhCAAIgGAAg");
            let mask_graphics_70 = new createjs.Graphics().p("A7QsaQg4gCg+gcQgtgUg+grQhTg4gpgrQgTgUgLggQgIgWgGglQgDgRACgKQABgNALgTQAKgSAMgNQASgUAcgIQAbgJAdADQAeADAhARQAUAJAnAWIAxAcQAeAQATAMIAdATQAQAKAOAEQAJADAWAEQAUADAKADQAcAJAdAfQAZAZAOAfQAPAgABAiQACAYgHAQQgTAxg9APQggAIg1AAIgYAAg");
            let mask_graphics_71 = new createjs.Graphics().p("A7csSQg4gDg9geQgsgVg9gsQhRg6gpgsQgSgUgLggQgHgXgFglQgCgRABgKQACgNALgSQALgTAMgMQATgTAcgIQAbgIAdAEQAdADAiARQATAKAmAYIAxAcQAdARATANIAcATQAQALAOAFQAKADAVAEQAUAEAKADQAbAJAeAgQAXAZAOAgQAOAhAAAiQABAXgHARQgUAvg+APQgbAFgqAAIgogBg");
            let mask_graphics_72 = new createjs.Graphics().p("A7nsJQg4gFg9gfQgrgWg8guQhQg8gogtQgSgVgJggQgHgWgEgmQgCgRACgKQACgNALgSQAMgSAMgMQAUgTAcgHQAbgHAdAEQAdAEAhASQATALAmAYIAwAeQAdARASAOIAcAUQAQALAOAFQAJADAVAFQAUAEAKADQAbAKAcAhQAYAaAMAgQANAhAAAiQAAAXgHARQgVAvg+ANQgXAEghAAQgYAAgdgCg");
            let mask_graphics_73 = new createjs.Graphics().p("A7zsBQg4gGg8ghQgqgXg7gvQhPg+gmguQgSgVgIghQgGgWgEgmQgBgRACgKQACgNAMgSQAMgRAMgMQAUgSAdgHQAbgGAdAFQAdAEAgAUQAUAKAkAaIAwAeQAcASATAOIAbAVQAPAMAOAFQAJAEAVAFQAUAEAJAEQAcALAbAhQAXAaAMAhQAMAhgBAiQgBAXgIARQgVAug/ALQgTAEgaAAQgcAAgkgEg");
            let mask_graphics_74 = new createjs.Graphics().p("A7/r5Qg4gHg7gjQgqgYg6gwQhNhAglgvQgRgWgHggQgGgXgCgmQgCgRADgKQACgNANgRQAMgRANgMQAUgSAdgFQAbgGAdAFQAdAGAgAUQATALAkAaIAvAgQAbATASAOIAbAVQAPAMAOAGQAJAEAVAGQATAFAKAEQAbALAbAiQAWAbALAhQALAhgCAiQgBAXgIAQQgXAvg/AJQgQACgTAAQggAAgqgFg");
            let mask_graphics_75 = new createjs.Graphics().p("A8LrxQg3gJg7gjQgpgag5gxQhLhCgkgwQgRgWgHghQgEgXgCgmQgBgRADgKQADgMANgRQAMgRANgMQAVgRAdgFQAbgFAdAGQAdAGAfAVQATAMAjAbIAuAhQAcATARAPIAaAWQAPAMAOAGQAJAEAVAHQATAFAJAEQAbAMAaAjQAVAbALAhQAKAigDAiQgBAXgJAQQgYAug/AIQgMABgPAAQgiAAgwgHg");
            let mask_graphics_76 = new createjs.Graphics().p("A8XrpQg3gKg5glQgpgag4gzQhJhEgjgwQgQgXgGghQgFgXAAgmQgBgRADgKQADgNAOgQQAMgRAOgLQAVgRAdgEQAcgFAcAHQAdAHAfAWQASAMAjAcIAtAiQAbAUARAPIAaAXQAOAMAOAHQAJAEAUAHQATAGAKAEQAaANAZAjQAVAcAJAhQAKAigDAiQgCAXgKAQQgZAtg/AGIgUABQgkAAg1gJg");
            let mask_graphics_77 = new createjs.Graphics().p("A8drlQg3gLg5glQgpgbg3gzQhJhFgigwQgQgXgGghQgEgXAAgmQAAgRADgKQADgNANgQQANgRAOgLQAVgQAdgEQAcgFAcAIQAdAHAfAWQASAMAjAcIAsAjQAbAUARAPIAZAXQAPANANAGQAJAFAVAHQATAGAJAEQAaANAZAjQAUAdAKAhQAJAigEAiQgCAXgJAQQgaAsg/AGIgSABQgkAAg3gKg");
            let mask_graphics_78 = new createjs.Graphics().p("A8kriQg3gLg4gmQgpgbg2g0QhJhFgigxQgPgXgGghQgEgXAAgmQAAgRADgKQAEgMANgRQANgQAOgLQAWgQAdgEQAbgEAcAHQAdAIAfAWQASAMAiAdIAtAjQAaAUARAQIAZAXQAPANANAGQAJAFAUAHQATAGAKAFQAaANAYAjQAUAdAJAhQAJAigEAiQgCAXgKAQQgaAsg/AGIgQAAQglAAg4gLg");
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_38).wait(26).to({_off:false},0).to({regX:12,regY:13.3,scaleX:0.9999,scaleY:0.9999,rotation:6.2761,x:-375.25,y:-237.9},5).wait(30).to({regX:12.1,regY:13.4,scaleX:1,scaleY:1,rotation:29.9996,x:-370.4,y:-231.9},5).to({_off:true},1).wait(194));
            ...
            let mask_1 = new createjs.Shape();
            mask_1._off = true;
            let mask_1_graphics_0 = new createjs.Graphics().p("A7qsEQgdgFgjgQQgOgHgtgZQglgVg2gnIhYhBQgygkgTgbQghgsAZgpQAPgYAqgWQAsgXAlgHQAzgJAdAOQAKAFAMAMIAUATIAwApQAcAYATATQAXAYAUANQAUANAIAdQAJAdAFAlIAFBEQACAXgBAIQgBAVgIAIQgHAHgUAAQgNAAgSgDg");
            let mask_1_graphics_1 = new createjs.Graphics().p("");
            let mask_1_graphics_2 = new createjs.Graphics().p("");
            let mask_1_graphics_3 = new createjs.Graphics().p("");
            let mask_1_graphics_4 = new createjs.Graphics().p("");
            let mask_1_graphics_5 = new createjs.Graphics().p("");
            let mask_1_graphics_6 = new createjs.Graphics().p("");
            let mask_1_graphics_7 = new createjs.Graphics().p("A75q4QgogBhDgVQg2gRgzgsQgmgggwg6QhBhOgbgzQgNgYgCgiQgBgYAEglQACgSAEgJQAFgLAPgQQASgQAMgIQAYgNAdgBQAbgBAbALQAcALAcAZQARAOAfAhIAoAnQAYAYAPARIAWAaQANAOANAIQAIAGATAJQATAJAJAFQAXAQAVAmQARAfAFAiQAFAjgIAhQgFAYgLANQgdAng7AAIgGAAg");
            let mask_1_graphics_8 = new createjs.Graphics().p("ACGD9QgrgDhBgXQgzgTg0gtQgqglgvg5Qg5hFgYgwQgMgYgBgjQgCgXAFghQACgRAFgKQAGgMAPgPQASgRAPgHQAYgMAdABQAcAAAbAMQAbAMAdAZQAQAOAeAfIApAnQAWAWAPAQIAXAZQAMANAOAIIAbAOQAUAKALAKQAXAQATAmQAQAfAEAiQAEAhgIAfQgJAbgSALQgeAhg3AAIgLAAg");
            let mask_1_graphics_9 = new createjs.Graphics().p("AB6D5QgsgEhAgaQgxgUg0guQgwgrgsg3Qgzg9gVguQgKgYgCgjQgBgWAEgdQADgRAHgLQAHgNAPgOQASgQARgHQAZgLAdACQAcACAcANQAZAMAeAaIAtArIAqAnIAjAjIAXAZQAMALAPAIIAcANQAVALANANQAWATASAlQAPAfACAiQADAggJAcQgLAegaALQgcAagzAAIgTgBg");
            let mask_1_graphics_10 = new createjs.Graphics().p("ABuD1QgugFg/gcQgvgWg0gvQg1gwgqg2Qgsg1gSgsQgJgXgBgkQgBgVAEgZQADgQAIgMQAIgOAPgNQATgRAUgGQAZgJAdADQAcADAcAPQAYAMAfAaIAtAqQATAQAXAWIAhAhIAYAXQALAKAQAIIAcANQAWALAQARQAWAVAPAkQAOAgABAiQACAegJAaQgOAhghAJQgbAUguAAIgcgCg");
            let mask_1_graphics_11 = new createjs.Graphics().p("ABjDyQgxgHg8gfQgugXg1gwQg6g2gog0QgkgugPgoQgIgYgBgkQAAgUADgWQADgPAJgNQAKgOAOgNQAUgQAWgGQAagIAcAEQAdAEAdARQAWAMAgAbIAtAoIAqAmIAfAeIAZAWQALAJARAIIAcAMQAXALARAWQAWAXAOAkQAMAgAAAiQABAcgJAXQgRAkgpAJQgZANgnAAQgSAAgUgCg");
            let mask_1_graphics_12 = new createjs.Graphics().p("ABXDuQgzgJg6ghQgsgYg2gyQg/g6gmg0QgdglgMgmQgHgYAAglQAAgTADgRQADgOALgPQAKgPAPgMQAUgQAZgFQAagHAcAFQAdAFAdATQAVAMAhAcIAsAmQAXATAUASIAdAcQAMAMAOAJQAKAIASAHQAQAGAMAGQAYAMAUAaQAVAZANAjQALAhgCAiQAAAagJAVQgUAmgwAIQgWAIggAAQgXAAgcgEg");
            let mask_1_graphics_13 = new createjs.Graphics().p("ABLDpQg0gJg5gkQgrgag2gyQhDhAgkgxQgXgfgJgkQgFgXAAglQAAgSADgOQADgOAMgPQAMgQAOgLQAVgQAbgFQAbgFAcAGQAdAGAeAVQATAMAiAcIAsAlQAYATATARIAbAaQANAMANAIQAKAGATAHIAdAMQAZAMAWAeQAUAbALAiQAKAigCAiQgCAYgJASQgXAqg4AHQgQADgVAAQgeAAgogHg");
            let mask_1_graphics_14 = new createjs.Graphics().p("A8kriQg3gLg4gmQgpgbg2g0QhJhFgigxQgPgXgGghQgEgXAAgmQAAgRADgKQAEgMANgRQANgQAOgLQAWgQAdgEQAbgEAcAHQAdAIAfAWQASAMAiAdIAtAjQAaAUARAQIAZAXQAPANANAGQAJAFAUAHQATAGAKAFQAaANAYAjQAUAdAJAhQAJAigEAiQgCAXgKAQQgaAsg/AGIgQAAQglAAg4gLg");
            let mask_1_graphics_31 = new createjs.Graphics().p("A8LtjQgugOhEgjQhbgwgrgkQgWgSgOgeQgKgVgLgkQgFgSAAgJQAAgNAJgUQAJgWAJgMQAQgVAbgMQAZgLAdgBQAegBAkANQAUAHApASQBVAiAUAJIAeAQQASAIAOACIAfADQAUABALACQAdAGAhAbQAbAVASAeQASAeAGAiQADAXgEARQgNAyg7AXQgmAOhGAGIgVABQguAAg1gRg");
            let mask_1_graphics_32 = new createjs.Graphics().p("AAKCyQgugNhFggQhcgtgtgjQgWgRgPgeQgLgTgLgkQgGgSAAgJQgBgNAIgUQAJgWAJgMQAPgWAagNQAZgLAdgCQAegCAkAMQAUAGAqARQBUAfAUAIIAfAPQASAHAOACQAKACAWAAQAUABAKABQAdAFAiAaQAcAUATAeQATAcAHAhQAEAYgEARQgLAyg7AZQglAPhFAIQgPACgPAAQgqAAgwgOg");
            let mask_1_graphics_33 = new createjs.Graphics().p("AAQCxQgvgMhFgeQhegqgtghQgXgQgQgeQgMgSgMgkQgGgSgBgIQgBgNAHgVQAIgWAJgMQAOgXAagNQAYgNAdgDQAegCAkAKQAVAFAqAQQBVAcAUAIIAgAOQASAHAOABIAfABQAUAAALABQAdAEAjAYQAcAUAUAdQAUAcAIAgQAFAYgDARQgKAyg5AbQglAQhFALQgSACgUAAQgmAAgsgKg");
            let mask_1_graphics_34 = new createjs.Graphics().p("AAVCuQgugKhGgcQhggngugfQgXgPgSgdQgLgUgOgiQgHgRgBgJQgBgNAHgVQAHgWAHgNQAOgXAagOQAXgOAdgDQAegDAkAIQAVAFArAOIBrAhIAgANQASAGAOABIAfAAIAfAAQAdACAkAYQAcATAVAcQAVAcAJAgQAGAWgCASQgJAyg4AdQglAShEAMQgXAFgZAAQgiAAgngJg");
            let mask_1_graphics_35 = new createjs.Graphics().p("AAbCsQgvgIhHgaQhhgkgvgeQgYgOgSgdQgNgTgPghQgHgSgBgIQgCgNAGgWQAGgWAIgNQANgXAZgPQAXgPAdgEQAegEAkAHQAVAEArANQBXAXAVAGIAhAMQASAGAOAAIAfgBQAUgBALAAQAdACAlAWQAdASAWAbQAWAcAKAfQAHAXgCARQgHAzg3AfQgkAShFAPQgaAGgeAAQgfAAghgGg");
            let mask_1_graphics_36 = new createjs.Graphics().p("A8OuhQgwgHhIgYQhigggxgdQgYgOgTgcQgNgSgQgiQgIgRgCgJQgCgNAFgVQAGgXAHgNQANgYAYgQQAXgPAdgGQAdgFAlAGQAWAEArALQBZAUAVAGIAhALQASAFAOAAIAggCQAUgDALABQAdAAAlAWQAeARAXAaQAXAbALAgQAHAXgBARQgFA0g3AgQgjAUhEARQgfAIgjAAQgaAAgdgEg");
            let mask_1_graphics_56 = new createjs.Graphics().p("A8OuhQgwgHhIgYQhigggxgdQgYgOgTgcQgNgSgQgiQgIgRgCgJQgCgNAFgVQAGgXAHgNQANgYAYgQQAXgPAdgGQAdgFAlAGQAWAEArALQBZAUAVAGIAhALQASAFAOAAIAggCQAUgDALABQAdAAAlAWQAeARAXAaQAXAbALAgQAHAXgBARQgFA0g3AgQgjAUhEARQgfAIgjAAQgaAAgdgEg");
            let mask_1_graphics_57 = new createjs.Graphics().p("AAbCsQgvgIhHgaQhhgkgvgeQgYgOgSgdQgNgTgPghQgHgSgBgIQgCgNAGgWQAGgWAIgNQANgXAZgPQAXgPAdgEQAegEAkAHQAVAEArANQBXAXAVAGIAhAMQASAGAOAAIAfgBQAUgBALAAQAdACAlAWQAdASAWAbQAWAcAKAfQAHAXgCARQgHAzg3AfQgkAShFAPQgaAGgeAAQgfAAghgGg");
            let mask_1_graphics_58 = new createjs.Graphics().p("AAVCuQgugKhGgcQhggngugfQgXgPgSgdQgLgUgOgiQgHgRgBgJQgBgNAHgVQAHgWAHgNQAOgXAagOQAXgOAdgDQAegDAkAIQAVAFArAOIBrAhIAgANQASAGAOABIAfAAIAfAAQAdACAkAYQAcATAVAcQAVAcAJAgQAGAWgCASQgJAyg4AdQglAShEAMQgXAFgZAAQgiAAgngJg");
            let mask_1_graphics_59 = new createjs.Graphics().p("AAQCxQgvgMhFgeQhegqgtghQgXgQgQgeQgMgSgMgkQgGgSgBgIQgBgNAHgVQAIgWAJgMQAOgXAagNQAYgNAdgDQAegCAkAKQAVAFAqAQQBVAcAUAIIAgAOQASAHAOABIAfABQAUAAALABQAdAEAjAYQAcAUAUAdQAUAcAIAgQAFAYgDARQgKAyg5AbQglAQhFALQgSACgUAAQgmAAgsgKg");
            let mask_1_graphics_60 = new createjs.Graphics().p("AAKCyQgugNhFggQhcgtgtgjQgWgRgPgeQgLgTgLgkQgGgSAAgJQgBgNAIgUQAJgWAJgMQAPgWAagNQAZgLAdgCQAegCAkAMQAUAGAqARQBUAfAUAIIAfAPQASAHAOACQAKACAWAAQAUABAKABQAdAFAiAaQAcAUATAeQATAcAHAhQAEAYgEARQgLAyg7AZQglAPhFAIQgPACgPAAQgqAAgwgOg");
            let mask_1_graphics_61 = new createjs.Graphics().p("A8LtjQgugOhEgjQhbgwgrgkQgWgSgOgeQgKgVgLgkQgFgSAAgJQAAgNAJgUQAJgWAJgMQAQgVAbgMQAZgLAdgBQAegBAkANQAUAHApASQBVAiAUAJIAeAQQASAIAOACIAfADQAUABALACQAdAGAhAbQAbAVASAeQASAeAGAiQADAXgEARQgNAyg7AXQgmAOhGAGIgVABQguAAg1gRg");
            let mask_1_graphics_78 = new createjs.Graphics().p("A8kriQg3gLg4gmQgpgbg2g0QhJhFgigxQgPgXgGghQgEgXAAgmQAAgRADgKQAEgMANgRQANgQAOgLQAWgQAdgEQAbgEAcAHQAdAIAfAWQASAMAiAdIAtAjQAaAUARAQIAZAXQAPANANAGQAJAFAUAHQATAGAKAFQAaANAYAjQAUAdAJAhQAJAigEAiQgCAXgKAQQgaAsg/AGIgQAAQglAAg4gLg");
            let mask_1_graphics_79 = new createjs.Graphics().p("ABLDpQg0gJg5gkQgrgag2gyQhDhAgkgxQgXgfgJgkQgFgXAAglQAAgSADgOQADgOAMgPQAMgQAOgLQAVgQAbgFQAbgFAcAGQAdAGAeAVQATAMAiAcIAsAlQAYATATARIAbAaQANAMANAIQAKAGATAHIAdAMQAZAMAWAeQAUAbALAiQAKAigCAiQgCAYgJASQgXAqg4AHQgQADgVAAQgeAAgogHg");
            let mask_1_graphics_80 = new createjs.Graphics().p("ABXDuQgzgJg6ghQgsgYg2gyQg/g6gmg0QgdglgMgmQgHgYAAglQAAgTADgRQADgOALgPQAKgPAPgMQAUgQAZgFQAagHAcAFQAdAFAdATQAVAMAhAcIAsAmQAXATAUASIAdAcQAMAMAOAJQAKAIASAHQAQAGAMAGQAYAMAUAaQAVAZANAjQALAhgCAiQAAAagJAVQgUAmgwAIQgWAIggAAQgXAAgcgEg");
            let mask_1_graphics_81 = new createjs.Graphics().p("ABjDyQgxgHg8gfQgugXg1gwQg6g2gog0QgkgugPgoQgIgYgBgkQAAgUADgWQADgPAJgNQAKgOAOgNQAUgQAWgGQAagIAcAEQAdAEAdARQAWAMAgAbIAtAoIAqAmIAfAeIAZAWQALAJARAIIAcAMQAXALARAWQAWAXAOAkQAMAgAAAiQABAcgJAXQgRAkgpAJQgZANgnAAQgSAAgUgCg");
            let mask_1_graphics_82 = new createjs.Graphics().p("ABuD1QgugFg/gcQgvgWg0gvQg1gwgqg2Qgsg1gSgsQgJgXgBgkQgBgVAEgZQADgQAIgMQAIgOAPgNQATgRAUgGQAZgJAdADQAcADAcAPQAYAMAfAaIAtAqQATAQAXAWIAhAhIAYAXQALAKAQAIIAcANQAWALAQARQAWAVAPAkQAOAgABAiQACAegJAaQgOAhghAJQgbAUguAAIgcgCg");
            let mask_1_graphics_83 = new createjs.Graphics().p("AB6D5QgsgEhAgaQgxgUg0guQgwgrgsg3Qgzg9gVguQgKgYgCgjQgBgWAEgdQADgRAHgLQAHgNAPgOQASgQARgHQAZgLAdACQAcACAcANQAZAMAeAaIAtArIAqAnIAjAjIAXAZQAMALAPAIIAcANQAVALANANQAWATASAlQAPAfACAiQADAggJAcQgLAegaALQgcAagzAAIgTgBg");
            let mask_1_graphics_84 = new createjs.Graphics().p("ACGD9QgrgDhBgXQgzgTg0gtQgqglgvg5Qg5hFgYgwQgMgYgBgjQgCgXAFghQACgRAFgKQAGgMAPgPQASgRAPgHQAYgMAdABQAcAAAbAMQAbAMAdAZQAQAOAeAfIApAnQAWAWAPAQIAXAZQAMANAOAIIAbAOQAUAKALAKQAXAQATAmQAQAfAEAiQAEAhgIAfQgJAbgSALQgeAhg3AAIgLAAg");
            let mask_1_graphics_85 = new createjs.Graphics().p("A75q4QgogBhDgVQg2gRgzgsQgmgggwg6QhBhOgbgzQgNgYgCgiQgBgYAEglQACgSAEgJQAFgLAPgQQASgQAMgIQAYgNAdgBQAbgBAbALQAcALAcAZQARAOAfAhIAoAnQAYAYAPARIAWAaQANAOANAIQAIAGATAJQATAJAJAFQAXAQAVAmQARAfAFAiQAFAjgIAhQgFAYgLANQgdAng7AAIgGAAg");
            let mask_1_graphics_86 = new createjs.Graphics().p("");
            let mask_1_graphics_87 = new createjs.Graphics().p("");
            let mask_1_graphics_88 = new createjs.Graphics().p("");
            let mask_1_graphics_89 = new createjs.Graphics().p("");
            let mask_1_graphics_90 = new createjs.Graphics().p("");
            let mask_1_graphics_91 = new createjs.Graphics().p("");
            let mask_1_graphics_92 = new createjs.Graphics().p("A7qsEQgdgFgjgQQgOgHgtgZQglgVg2gnIhYhBQgygkgTgbQghgsAZgpQAPgYAqgWQAsgXAlgHQAzgJAdAOQAKAFAMAMIAUATIAwApQAcAYATATQAXAYAUANQAUANAIAdQAJAdAFAlIAFBEQACAXgBAIQgBAVgIAIQgHAHgUAAQgNAAgSgDg");
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_40).wait(31).to({_off:false},0).to({rotation:-23.7228,x:-386.65,y:-252},5).wait(20).to({rotation:6.2761,x:-375.25,y:-237.9},5).to({_off:true},1).wait(199));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_62).wait(261));

            // BrasFond
            this.instance_63 = new lib.CachedBmp_467();
            this.instance_63.setTransform(-431.2,-224.25,0.1313,0.1313);

            this.timeline.addTween(createjs.Tween.get(this.instance_63).wait(56).to({_off:true},36).wait(169));

            // Tete
            this.instance_64 = new lib.Tete();
            this.instance_64.setTransform(-436.2,-288.85,1,1,0,0,0,27.9,31.7);

            this.timeline.addTween(createjs.Tween.get(this.instance_64).wait(19).to({regX:27.8,rotation:-14.9992,x:-442.5,y:-292.95},17).wait(20).to({regX:27.9,rotation:0,x:-436.2,y:-288.85},17).wait(188));
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_85},{t:this.instance_84}]}).wait(261));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_93).wait(7).to({_off:false},0).wait(8).to({x:-373,y:-185.45,alpha:0},11).to({_off:true},1).wait(39).to({_off:false},0).to({x:-366.85,y:-193.65,alpha:1},11).to({_off:true},9).wait(175));
            ...
            this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.instance_149}]}).to({state:[]},7).to({state:[{t:this.instance_150}]},79).wait(175));

            // Ombre_ordinateur
            this.instance_151 = new lib.CachedBmp_548();
            this.instance_151.setTransform(-418.7,-211.15,0.1313,0.1313);

            this.timeline.addTween(createjs.Tween.get(this.instance_151).wait(261));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_152).wait(194).to({_off:false},0).to({_off:true},57).wait(10));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_153).wait(179).to({_off:false},0).to({_off:true},57).wait(25));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_154).wait(163).to({_off:false},0).to({_off:true},57).wait(41));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_155).wait(149).to({_off:false},0).to({_off:true},57).wait(55));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_156).wait(134).to({_off:false},0).to({_off:true},57).wait(70));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_157).wait(118).to({_off:false},0).to({_off:true},57).wait(86));
            ...
            this.timeline.addTween(createjs.Tween.get(this.instance_158).wait(104).to({_off:false},0).to({_off:true},57).wait(100));
            this._renderFirstFrame();
        }).prototype = p = new createjs.MovieClip();

        p.nominalBounds = new createjs.Rectangle(-497,-330.7,184.89999999999998,164.89999999999998);
        ...
        p.nominalBounds = new createjs.Rectangle(419.1,313.5,304.1,300.29999999999995);
        ...
        this.adobeAn.compositions['D3CB6FFFDF67F64A8559800DB3246B17'] = {
    ...
    initAnimation = function () {
        this.global_container = document.getElementById("computer_global_container");
        this.canvas = document.getElementById("computer_canvas");
        this.anim_container = document.getElementById("computer_animation_container");
        this.dom_overlay_container = document.getElementById("computer_dom_overlay_container");

        let comp = this.adobeAn.getComposition("D3CB6FFFDF67F64A8559800DB3246B17");
    ...
    handleComplete = function (evt, comp) {
        ...
        this.exportRoot = new lib.Moi_FullSize();
